...
* Model: 2.5 Pro
  * Default setting(Thinking budget is not set): Dynamic thinking: Model decides when and how much to think
  * Range: 128 to 32768
...
* Model: 2.5 Flash
  * Default setting(Thinking budget is not set): Dynamic thinking: Model decides when and how much to think
  * Range: 0 to 24576
  * Disable thinking: thinkingBudget = 0
  * Turn on dynamic thinking: thinkingBudget = -1
...
* Model: 2.5 Flash Lite
  * Default setting(Thinking budget is not set): Model does not think
  * Range: 512 to 24576
  * Disable thinking: thinkingBudget = 0
  * Turn on dynamic thinking: thinkingBudget = -1
* Model: 2.5 Flash Lite Preview
  * Default setting(Thinking budget is not set): Model does not think
  * Range: 512 to 24576
  * Disable thinking: thinkingBudget = 0
  * Turn on dynamic thinking: thinkingBudget = -1
* Model: Robotics-ER 1.5 Preview
  * Default setting(Thinking budget is not set): Dynamic thinking: Model decides when and how much to think
  * Range: 0 to 24576
  * Disable thinking: thinkingBudget = 0
  * Turn on dynamic thinking: thinkingBudget = -1
