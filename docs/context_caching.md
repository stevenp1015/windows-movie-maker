...
*   The _minimum_ input token count for context caching is 1,024 for 2.5 Flash and 2,048 for 2.5 Pro. The _maximum_ is the same as the maximum for the given model. (For more on counting tokens, see the Token guide).
