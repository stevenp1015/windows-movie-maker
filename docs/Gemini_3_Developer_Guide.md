...
* Model ID: gemini-3-pro-preview
  * Context Window (In / Out): 1M / 64k
  * Knowledge Cutoff: Jan 2025
  * Pricing (Input / Output)*: $2 / $12 (<200k tokens)  $4 / $18 (>200k tokens)
* Model ID: gemini-3-pro-image-preview
  * Context Window (In / Out): 65k / 32k
  * Knowledge Cutoff: Jan 2025
  * Pricing (Input / Output)*: $2 (Text Input) / $0.134 (Image Output)**


_\* Pricing is per 1 million tokens unless otherwise noted._ _\*\* Image pricing varies by resolution. See the pricing page for details._
...
* Media Type: Images
  * Recommended Setting: media_resolution_high
  * Max Tokens: 1120
  * Usage Guidance: Recommended for most image analysis tasks to ensure maximum quality.
* Media Type: PDFs
  * Recommended Setting: media_resolution_medium
  * Max Tokens: 560
  * Usage Guidance: Optimal for document understanding; quality typically saturates at medium. Increasing to high rarely improves OCR results for standard documents.
* Media Type: Video (General)
  * Recommended Setting: media_resolution_low (or media_resolution_medium)
  * Max Tokens: 70 (per frame)
  * Usage Guidance: Note: For video, low and medium settings are treated identically (70 tokens) to optimize context usage. This is sufficient for most action recognition and description tasks.
* Media Type: Video (Text-heavy)
  * Recommended Setting: media_resolution_high
  * Max Tokens: 280 (per frame)
  * Usage Guidance: Required only when the use case involves reading dense text (OCR) or small details within video frames.
...
7.  **Which tools are supported in Gemini 3?** Gemini 3 supports Google Search, File Search, Code Execution, and URL Context. It also supports standard Function Calling for your own custom tools. Please note that Google Maps and Computer Use are currently not supported.